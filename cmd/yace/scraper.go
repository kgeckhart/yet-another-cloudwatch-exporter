...
func (s *scraper) decoupled(ctx context.Context, logger logging.Logger, cache session.ClientCache) {
...
func (s *scraper) scrape(ctx context.Context, logger logging.Logger, cache session.ClientCache) {
	if !sem.TryAcquire(1) {
